...
import { HomeSliderItem } from "@/features/image/types";
...
const Hero = () => {
  const { isSuccess, data } = useGetSliderImagesQuery(null);
  let sliderImageItems: HomeSliderItem[] = [];
  if (isSuccess) {
